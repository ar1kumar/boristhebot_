...
bookingSchema.statics.findBookingsOnDate = function(date, approx, court_id, callback){
...
var Agent = function(){
	...
	this.checkWeatherForBooking = function(sender_id, callback){
		var gmap = new GMap(),
			weather = new Weather(),
			self = this;
	...
	this.getBookingID = function(sender_id, callback){
	...
	this.getBookingByID = function(booking_id, callback){
	...
	this.checkCourtTimes = function(date, approx, court_id, callback){
		...
		Booking.findBookingsOnDate(date, approx, court_id, function(error, bookings){
			if(error){
				callback(error, []);
			} else {
