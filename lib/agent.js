...
var Agent = function(){
	...
	this.getBookingsDayBeforeYesterday = function(callback){
		var today = new Date();
		var beforeYesterday = today.setDate(today.getDate()-2);
		Booking.findAllBookingsOnDate(beforeYesterday.getTime(), 1, function(error, bookings){
			callback(error, bookings);
		});
	}
